...
class CarsAPIView(APIView):
    ...
    def put(self, request, *args, **kwargs):
        id = request.query_params["id"]
        car_object = front.objects.get(id=id)
    ...
    def patch(self, request, *args, **kwargs):
        car_object = FrontDeskModel.objects.get()
        data = request.data
        car_object.active = data.get("active", car_object.car_brand)
        car_object.save()
        serializer = FrontDeskSerializer(car_object)
